...
Bientôt, la forêt s'ouvre devant vous, sombre et menaçante. La quête commence.", '../images/scene-fantastique-en-3d.jpg'),
...
noueux ; l’autre droit mais envahi par des ronces épaisses.", '../images/ronce_foret.png'),
...
se fait entendre. Vous ressentez la présence d’un prédateur.", '../images/arbre_corbeaux.png'),
...
brutalement de vous charger !", '../images/sanglier_combat.png'),
...
retentissent depuis le cœur de la forêt… Des créatures rôdent. »", '../images/rencontre_paysan.png'),
(6, "Le loup noir","
...
à bondir.
Le combat est inévitable »", '../images/loup_noir_combat.png'),
...
ombres des pierres semblent danser sous la lueur de la lune.", '../images/clairiere_pierre_ancienne.png'),
...
pierre moussue.", '../images/ruisseau.png'),
...
peut-être pas qu’une légende…", '../images/pied_chateau.png'),
...
qui vous ont mené à votre perte.", '../images/lumiere_bout_neant.png'),
(11, "La curiosité tua le chat","

Qu’avez-vous fait, Malheureux !", 'images/game_over.png')
;
